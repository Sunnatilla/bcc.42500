        ...
        .then((response) => {
          ...
          if (
            ...
            if (model.createClientResult.data.p_id == "null") {
              ...
              setShowErrorMsg("У вас имеются ограничения на открытие карты.");
            } else if (model.bnpResult.data[0].inactive == 1) {
              setShowErrorMsg(
                "Вы числитесь в базе бездействующих налогоплательщиков. Просим обратиться в налоговый орган."
              );
            } else {
              setStep(6);
            }
            ...
            if (
              ...
              setShowErrorMsg(
                "У вас имеются ограничения на открытие карты. Просим обратиться в отделение банка."
              );
            } else if (model.bnpResult.data[0].inactive == 1) {
              setShowErrorMsg(
                "Вы числитесь в базе бездействующих налогоплательщиков. Просим обратиться в налоговый орган."
